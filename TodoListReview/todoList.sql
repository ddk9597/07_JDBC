...
COMMENT ON COLUMN TB_TODO.COMPLETE IS '완료 여부';
COMMENT ON COLUMN TB_TODO.REG_DATE IS '할일 등록일';
...
-- 샘플 데이터 추가
INSERT INTO TB_TODO 
VALUES(SEQ_TODO_NO.NEXTVAL, '테스트 제목 1', '테스트 내용1', DEFAULT, DEFAULT);

INSERT INTO TB_TODO 
VALUES(SEQ_TODO_NO.NEXTVAL, '테스트 제목 2', '테스트 내용2', DEFAULT, DEFAULT);

INSERT INTO TB_TODO 
VALUES(SEQ_TODO_NO.NEXTVAL, '테스트 제목 3', '테스트 내용3', DEFAULT, DEFAULT);
